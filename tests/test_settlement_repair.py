...
class SettlementRepairTest(unittest.TestCase):
    ...
    def test_run_settlement_repair_rebuilds_after_partial_price_repair_progress(
        self,
        _mock_load_settings,
        _mock_available_strategy_versions,
        mock_repair_targets,
        ...
        fresh_report = {
            ...
            "settlement_date": "2026-05-07",
            "settlement_row_count": 100,
            "settled_1d_row_count": 96,
            "settled_1d_ratio": 0.96,
        }
        mock_repair_targets.side_effect = [
            ({"v1": stale_report}, {"v1": {"600001", "600002"}}, {"v1": "2026-05-08"}),
            ({"v1": fresh_report}, {}, {}),
        ]
        mock_repair_price_caches.return_value = {
            "target_date": "2026-05-08",
